  ...
  about: {
    ...
    story: {
      ...
      beats: [
        {
          year: "1881",
          label: "The first foundation",
          body: "The first foundation in Cochrane went down on the Bow. The winters that followed were brutal. It held anyway. The rule it set still runs this town: build to outlast the builder.",
          image: "/heritage/cochrane-ranche-1881.jpg",
          aspect: "aspect-[3/2]",
          alt: "The historic Cochrane Ranche on the Bow River, where building in Cochrane began in 1881",
          credit: { name: "davebloggs007", license: "CC BY 2.0", licenseUrl: "https://creativecommons.org/licenses/by/2.0/", sourceUrl: "https://commons.wikimedia.org/wiki/File:Cochrane_Ranch_Alberta_Canada_(27026269913).jpg" },
        },
        {
          year: "1885",
          label: "The town the builders raised",
          body: "Steel reached the valley and set a town where the river met the grassland. They named it Cochrane. The hands that laid that track were building a place most of them would never live in.",
          image: "/heritage/cochrane-town.jpg",
          aspect: "aspect-[2/1]",
          alt: "Cochrane, Alberta seen from the western hills — the town generations of builders raised",
          credit: { name: "Chuck Szmurlo", license: "CC BY 2.5", licenseUrl: "https://creativecommons.org/licenses/by/2.5/", sourceUrl: "https://commons.wikimedia.org/wiki/File:Cochrane-Szmurlo.jpg" },
        },
        {
          year: "Early 1900s",
          label: "The masons",
          body: "Quarry, sawmill, brick plant — the trades of foundation and frame. The sandstone those hands cut still carries First Street West, a hundred years after they were gone.",
          image: "/heritage/collins-brickyard.jpg",
          aspect: "aspect-[3/2]",
          alt: "The Collins brickyard near Cochrane — the trades of foundation and frame that built the town",
          credit: { name: "Jason Woodhead", license: "CC BY 2.0", licenseUrl: "https://creativecommons.org/licenses/by/2.0/", sourceUrl: "https://commons.wikimedia.org/wiki/File:COLLINS_BRICKYARD_COCHRANE_(8541285750).jpg" },
        },
        {
          year: "Today",
