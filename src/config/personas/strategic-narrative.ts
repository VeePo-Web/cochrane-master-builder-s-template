...
export const STRATEGIC_NARRATIVE = {
  ...
  differentiators: {
    mobileConvenience: {
      label: "Full mobile service — we come to you",
      description: "The entire restoration happens at the customer's location. No drop-offs, no coordination, no wasted time. Gas and travel included in every price.",
    },
    deepRestoration: {
    ...
    transparentPricing: {
      ...
      description: "Full resets from ~$100. No hidden fees, no mileage surcharges, no surprise upsells at the door. The price is the price.",
    },
    proofDriven: {
  ...
  serviceArea: {
    ...
    expanded: "All Calgary neighborhoods — NW, NE, SW, SE, and surrounding communities. Gas and travel included in every booking.",
  },
