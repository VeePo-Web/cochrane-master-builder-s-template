...
export const VISUAL_PERSONA = {
  ...
  principles: {
    ...
    authenticPhotography: "Use real detailing photography — before/after reveals, studio-lit close-ups of paint correction, ceramic coating application, interior restoration. No generic stock.",
  ...
  decisions: {
    ...
    whitespace: {
      ...
      rationale: "Whitespace says 'we don't need to cram.' It creates calm confidence — the same feeling a client gets walking into a spotless, organized detailing bay.",
    },
    imagery: {
      rule: "Professional automotive detail photography only — before/after reveals, studio-lit close-ups, paint correction transformations, ceramic coating application. No generic stock.",
    ...
    shadows: {
      rule: "Subtle, consistent shadow system — light source from top-left. Shadows create depth suggesting the multi-layer nature of paint protection.",
      rationale: "Shadows create depth and hierarchy; inconsistent shadows feel broken. The layered shadow approach mirrors ceramic coating layers.",
    },
    borders: {
    ...
    textureAndMood: {
      ...
      rationale: "The visual language must evoke the detailing bay — controlled light, reflective surfaces, obsessive cleanliness, technical precision.",
    },
    callsToAction: {
      ...
      rationale: "Strategic CTAs guide the user journey. 'Book Your Detail,' 'See Our Work,' 'Get a Quote' — clear, confident, premium-feeling.",
    },
    contentHierarchy: {
  ...
  symbolismAndMotifs: {
    ...
    motifs: {
      ...
      precisionGeometry: "Clean lines, exact angles, mathematical spacing. Grid systems that feel engineered, not artistic. The visual equivalent of tape lines on a vehicle.",
  ...
  motionDesign: {
    ...
    microInteractions: {
      ...
      examples: "A 'Book Now' button might emit a subtle sheen on hover — like light catching a ceramic-coated surface. Service cards might reveal depth on hover, suggesting layers of protection.",
    },
    pageTransitions: {
  ...
  contentAndStorytelling: {
    ...
    userPersonas: {
      ...
      fleetManager: "Manages multiple vehicles, values efficiency, reliability and consistent quality. Needs clear service tiers and bulk options.",
      newClient: "First-time detailing customer, may be skeptical, needs education on value and process. Trust signals are critical.",
    },
    ...
    headingsAsInvitations: "Headings should inspire curiosity and confidence — 'See the Difference,' 'Our Process,' 'Your Vehicle Deserves Better' — not just label sections.",
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  proofHierarchy: {
    purpose: "Visual proof elements ranked by trust impact for premium auto detailing",
    order: [
  ...
  // ═══════════════════════════════════════════════════════════════════
  // ANTI-PATTERNS (expanded to 15+, automotive context)
  // ═══════════════════════════════════════════════════════════════════
  antiPatterns: [
    ...
    "Generic auto shop template aesthetic — cluttered, loud, unprofessional",
    "Low-quality car photos — phone snapshots, poor lighting, cluttered backgrounds",
    "Stock imagery of vehicles that aren't representative of actual work",
  ...
  designProcess: {
    step1_brandFoundation: {
      ...
      developMotifs: "Identify symbols or patterns that reflect the brand narrative — ceramic sheen, paint depth layers, precision geometry. Create a consistent icon library for services.",
    },
    ...
    step3_highFidelityDesign: {
      ...
      authenticImagery: "Use real detailing photography. Plan shoots if needed — controlled lighting, clean backgrounds, detail-focused compositions.",
