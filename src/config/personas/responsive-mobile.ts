/**
 * CALEM WOOD — Responsive Mobile Experience Persona
 * 
...
export const RESPONSIVE_MOBILE_PERSONA = {
  ...
  philosophy: {
    ...
    forCalemWood: "Calem Wood's mobile experience must feel like inspecting a flawless ceramic coating up close — every detail precise, every surface considered. Mobile is where most vehicle owners research detailing services and book appointments on-the-go.",
  ...
  breakpoints: {
    smallPhone: "320–375px — Single column, maximum content prioritization, generous touch targets. Calem Wood's service cards stack vertically, booking CTA dominates thumb zone.",
  ...
  mobileNavigation: {
    patternSelection: "For 5–7 nav items: full-screen overlay that feels like opening the door to Calem Wood's showroom — elegant, intentional reveal. For fewer items, consider bottom navigation bar or segmented controls.",
    ...
    forCalemWood: "Navigation should feel as precise and intentional as Calem Wood's detailing process — every tap leads somewhere purposeful. The Book Now CTA is always within reach, like the confidence of knowing your vehicle is in expert hands.",
  },
  ...
  mobileTypography: {
    ...
    contrast: "Ensure text meets WCAG AA contrast minimums. Test in bright outdoor conditions — Calem Wood's clients may browse from parking lots or driveways in direct sunlight.",
  },
  ...
  mobileMedia: {
    ...
    forCalemWood: "Before/after galleries are Calem Wood's most powerful conversion tool. On mobile, use swipe-to-reveal or slider interactions that feel tactile and satisfying. Every vehicle image must look stunning at any viewport — crisp paint reflections, sharp detail shots.",
  },
  ...
  touchInteractions: {
    ...
    forms: "Appropriate input types (tel for phone, email for email). Auto-complete enabled. Minimal fields — Calem Wood's booking form should capture only essentials: name, phone, vehicle, service interest. Inline validation with friendly error messages.",
    forCalemWood: "Touch feedback should feel refined and precise — matching Calem Wood's meticulous craftsmanship. A gentle press response, a smooth slide for before/after reveals, a satisfying confirmation on booking submission.",
  ...
  mobilePerformance: {
    loadTime: "Sub-3-second load on 4G networks. Test on throttled connections — Calem Wood's clients may browse on cellular data while at a car wash or dealership.",
  ...
  mobileAccessibility: {
    ...
    keyboardNav: "Full keyboard navigation support for users with motor impairments. Focus indicators must be visible and styled consistently with Calem Wood's brand.",
    ...
    darkMode: "Dark mode variants that respect user system preferences. Improve battery life on OLED screens and provide a premium feel that matches Calem Wood's dark, sophisticated brand palette.",
  },
  ...
  processMethodology: {
    ...
    personas: "Create user personas for Calem Wood's mobile users: the busy professional booking on a lunch break, the car enthusiast researching services at a meet, the referral visitor checking out the portfolio on the way to the shop.",
  ...
  agencyWisdom: {
    rga: "R/GA's commitment to storytelling and emotional engagement — Calem Wood's mobile experience should tell the story of transformation, not just list services.",
    ...
    synthesis: "Synthesize these perspectives to create a Calem Wood mobile experience that is functional, emotionally resonant, and unmistakably premium. Use qualitative research (interviews, contextual inquiry) and quantitative tools (heatmaps, A/B testing) to validate every decision.",
  },
  ...
  qualityAssurance: {
    ...
    crossBrowser: "Safari (iOS), Chrome (Android), Samsung Internet. These three cover 95%+ of Calem Wood's likely mobile audience.",
  ...
  continuousImprovement: {
    ...
    teamCulture: "Foster collaboration between designers, developers, and the Calem Wood team. Performance and mobile excellence is everyone's responsibility.",
  },
