...
export const MARKET_RESEARCH = {
  ...
  competitors: {
    ...
    cheapMobileCleaners: {
      ...
      opportunityForCochrane Master Builders: "Differentiate through restoration-level transformation, especially for dirty cars and overdue homes.",
    },
    ...
    diyAlternatives: {
      ...
      opportunityForCochrane Master Builders: "Market the service as the moment when the home has moved beyond 'quick clean' and needs a real reset.",
    },
  },
