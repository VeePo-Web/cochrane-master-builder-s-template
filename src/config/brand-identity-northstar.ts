...
export const BRAND_IDENTITY_NORTHSTAR = {
  ...
  brandTruthTable: [
    ...
    {
      truth: "Strongest demand comes from pain threshold, not interest in detailing",
    ...
    {
      truth: "Traditional detailing requires drop-off, coordination, and lost time",
      source: "business-overview",
  ...
  customerMirror: {
    ...
    languageBank: {
      desires: [
        "I just want my car to feel new again",
        ...
        "I want to feel like I got a new car without buying one",
  ...
  storySystem: {
    ...
    taglineDirections: [
      ...
      "Your car deserves better. We deliver it.",
      "Clean is the starting line. Restored is the finish.",
      "Feel the difference in the driver's seat.",
    ...
    pillars: [
      ...
      },
      {
        ...
        headlines: [
          ...
          "Mobile detailing that actually shows up.",
        ...
        subheads: [
          ...
          "While you work, rest, or go about your day — your car gets reset.",
      ...
      },
      {
        ...
        headlines: [
          ...
          "Real cars. Real Calgary. Real transformation.",
        ...
        subheads: [
          ...
          "Calgary drivers who tried us once keep coming back. The results are why.",
        ],
        ctas: [
          "Browse the gallery",
      ...
      },
      {
        ...
        headlines: [
          ...
          "Your car's condition isn't a problem. It's our specialty.",
  ...
  verbalIdentity: {
    voiceTraits: [
      ...
      {
        trait: "Honest",
        soundsLike: "Here's what the detail includes, here's the price, here's what your car will look like after.",
        neverSoundsLike: "We pride ourselves on our unwavering commitment to transparency and integrity.",
      },
      {
        trait: "Satisfying",
        soundsLike: "The before/after is the best part. You'll see it. You'll feel it. You'll sit in your car and just... exhale.",
        neverSoundsLike: "We ensure optimal client satisfaction through our proprietary methodology.",
      },
      {
        trait: "Confident",
        soundsLike: "We've done this hundreds of times. Your car's condition doesn't scare us.",
    ...
    copyExamples: {
      good: [
        "Your car's been through a lot. We bring it back.",
  ...
  whatNotToDo: {
    messaging: [
      ...
      "Never shame the customer ('Is your car embarrassing?' 'Time to stop being lazy')",
