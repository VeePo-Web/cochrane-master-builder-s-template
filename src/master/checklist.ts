...
export const REMIX_CHECKLIST: CheckItem[] = [
  ...
  { id: "master-favicon-pwa-pack-embedded", group: "setup", automated: true, label: "Favicon + PWA icon pack embedded", description: "Full 13-rung navy MB-diamond ladder in /public/ — favicon.ico + favicon-16/32/48/64/96/128/144/152/180/192/256.png + android-chrome-192/512 + apple-touch-icon, plus site.webmanifest. Wired into index.html via <link rel='icon|apple-touch-icon|manifest'> at every size + <meta name='msapplication-TileImage|TileColor'> for Windows pinned tiles. Unlocks crisp browser-chrome rendering on every desktop, iOS/Android device, and PWA install context — no service worker required." },
