...
export const REMIX_CHECKLIST: CheckItem[] = [
  ...
  { id: "master-wordmark-binaries-embedded", group: "setup", automated: true, label: "Master wordmark binaries embedded", description: "Pure-typography wordmark PNGs (200/400/800/1200/2400) wired through <MasterLogo slot='wordmark' size={…}>. Black ✅; navy + white aliased to black until those packages land (see WORDMARK_STATUS)." },
